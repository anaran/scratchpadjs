...
(function() {
  ...
  for (let i = 0, len = document.links.length; i < len; i++) {
    if (i > MAX_LINKS) {
      window.alert('This is getting silly after ' + MAX_LINKS + ' links.\nEven crashed Firefox nightly for me.');
      // Crashes observed without this limit are in https://bugzilla.mozilla.org/show_bug.cgi?id=912121 as of this commit.
      break;
    }
  ...
  DEBUG && console.log(linkContainer.outerHTML);
  DEBUG && console.log(document.body.lastElementChild);
})();
/*
